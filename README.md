...
[![Maintenance](https://img.shields.io/badge/Maintained%3F-yes-green.svg)](https://github.com/duannbusiness/rails-devise-graphql/graphs/commit-activity)
[![GitHub license](https://img.shields.io/github/license/Naereen/StrapDown.js.svg)](https://github.com/duannbusiness/rails-devise-graphql/blob/master/LICENSE)
![GitHub top language](https://img.shields.io/github/languages/top/duannbusiness/rails-devise-graphql)
![GitHub issues](https://img.shields.io/github/issues/duannbusiness/rails-devise-graphql)
...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/duannbusiness/rails-devise-graphql) 

or clone this repo:

```sh
git clone https://github.com/duannbusiness/rails-devise-graphql
...
**Note:** Make sure that the `.env` file is included in the root of your project and you have defined `CLIENT_URL` and `DEVISE_SECRET_KEY`. Read more about the JSON Web Token [this](https://github.com/duannbusiness/rails-devise-graphql). There are plenty of packages available.
...
__Script:__ <https://github.com/duannbusiness/rails-devise-graphql>